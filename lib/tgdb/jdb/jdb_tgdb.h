#ifndef __JDB_TGDB_H__
#define __JDB_TGDB_H__
 ...
 * jdb_tgdb.h
 * \brief
 * This interface documents the jdb context.
 */

/** 
 * This struct is a reference to a libjdb instance.
 */
struct tgdb_jdb;

/**  
 * This should probably be moved out of jdb_tgdb.h
 */
enum jdb_commands {
	 ...
	 */
    JDB_INFO_SOURCE_RELATIVE,

    /**
	 * absolute source path.
	 */
    JDB_INFO_SOURCE_ABSOLUTE,
 ...
 */
void *jdb_create_context(const char *debugger_path,
 ...
 * 0 on success, otherwise -1 on error.
 */
int jdb_get_source_absolute_filename(void *ctx, const char *file);
 ...
 * 0 on success, otherwise -1 on error.
 */
int jdb_change_prompt(void *ctx, const char *prompt);
 ...
 * 0 on success, otherwise -1 on error.
 */
int jdb_command_callback(void *ctx, const char *command);
